...
export const Route = createFileRoute('/_app/analytics/stock')({
  component: AnalyticsStockPage,
})
...
const locationConfig = {
  qty: { label: 'Kuantitas', color: 'hsl(var(--primary))' },
    ...
    <Page>
      ...
      <Page.Content className='mt-2'>
        <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-4'>
          ...
          <CardStat
            title='Barang Masuk (Bln Ini)'
            value='+21,000'
            icon={ArrowDownRightIcon}
          />
          <CardStat
            title='Barang Keluar (Bln Ini)'
            value='-19,000'
