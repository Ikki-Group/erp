...
| [production.md](./production.md)   | Production Recipes, Production Orders  |
...
| production_recipes.material_id      | materials          | Output material     |
| production_recipe_lines.material_id | materials          | Input consumed      |
| production_orders.location_id       | locations          | Produced at         |
| production_orders.recipe_id         | production_recipes | Recipe used         |
