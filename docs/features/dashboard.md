...
- **Low Stock Alerts Table**: A dedicated data grid showing materials that have fallen below their "Minimum Threshold" at specific locations (e.g., _Ikki Coffee Bar_ only has 2kg of Espresso Beans left).
- **Pending Internal Requests**: Quick approval buttons for Outlet Managers to approve stock transfers from _Gudang Utama_ to their specific outlet.
