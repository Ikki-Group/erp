...
- **Role Guards**: A custom Elysia macro (e.g., `isLoggedIn: true`, `requirePermission: 'inventory:create'`) intercepts unauthorized users _before_ they even hit the core business logic in the `Service` layer.
