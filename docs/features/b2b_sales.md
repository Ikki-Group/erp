...
2. **Sales Order (SO)**: The confirmed order. *Crucial ERP Action:* This formally reserves the inventory in Gudang Utama so it cannot be transferred to Ikki Resto.
