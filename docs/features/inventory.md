...
- **Receiving from Suppliers**: Goods Receipt Notes (GRN) when bulk ingredients (e.g., 50kg Coffee Beans, 100 boxes of Milk) arrive at *Gudang Utama*.
- **Direct to Outlet**: Occasional direct deliveries from suppliers straight to *Ikki Resto* or *Ikki Coffee* kitchens.
...
- **Sheet Generation**: System generates a digital checklist of expected stock for a specific location (e.g., *Ikki Coffee - Bar Area*).
- **Data Entry**: Baristas input the *actual* physical count.
