...
- **BOM Allocation**: The system locks 24 kg of _Green Beans_ from the warehouse inventory so it cannot be used for anything else during the roasting process.
