...
export const formRegistry: ComponentRegistry = {
	...
	components: [
		...
		},
		{
			...
			usage:
				'Used by high-level field components. Standardizes ARIA attributes and error visibility logic.',
		...
		},
		{
			...
			usage:
				'Use `<form.Form>` for layout and `<form.SimpleActions />` for standard save/cancel buttons.',
