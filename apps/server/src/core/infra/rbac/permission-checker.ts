...
export class PermissionChecker {
  ...
  static check(
    ...
    if (mode === "AND") {
      return this.checkAll(userPermissions.permissions, required)
    } else {
      return this.checkAny(userPermissions.permissions, required)
    }
  }
  ...
  private static hasPermission(
    ...
    return (
      userPermissions.includes(SUPERADMIN_PERMISSION) ||
