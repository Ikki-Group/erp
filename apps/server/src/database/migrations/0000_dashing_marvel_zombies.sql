CREATE TYPE "public"."location_type" AS ENUM('store', 'warehouse', 'central_warehouse');--> statement-breakpoint
...
ALTER TABLE "user_role_assignments" ADD CONSTRAINT "user_role_assignments_roleId_roles_id_fk" FOREIGN KEY ("roleId") REFERENCES "public"."roles"("id") ON DELETE restrict ON UPDATE no action;