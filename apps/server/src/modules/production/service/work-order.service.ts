...
export class WorkOrderService {
  ...
  async handleList(filter: WorkOrderFilterDto, pq: PaginationQuery): Promise<WithPaginationResult<WorkOrderDto>> {
  ...
  async handleComplete(id: number, data: WorkOrderCompleteDto, actorId: number): Promise<WorkOrderDto> {
