...
export function initEmployeeRoute(module: EmployeeServiceModule) {
  ...
  return new Elysia({ prefix: '/employee' })
    ...
    .get(
      ...
      { query: dto.EmployeeFilterDto, response: createPaginatedResponseSchema(dto.EmployeeDto), auth: true },
    )
    .get(
      '/detail',
    ...
    .post(
      ...
      { body: dto.EmployeeCreateDto, response: createSuccessResponseSchema(zRecordIdDto), auth: true },
    )
    .patch(
      '/update',
      ...
      { body: dto.EmployeeUpdateDto, response: createSuccessResponseSchema(zRecordIdDto), auth: true },
    )
    .delete(
      '/remove',
