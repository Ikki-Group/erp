...
export function initSupplierRoute(module: SupplierServiceModule) {
  ...
  return new Elysia({ prefix: '/supplier' })
    ...
    .get(
      ...
      { query: dto.SupplierFilterDto, response: createPaginatedResponseSchema(dto.SupplierDto), auth: true },
    )
    .get(
      '/detail',
    ...
    .post(
      ...
      { body: dto.SupplierCreateDto, response: createSuccessResponseSchema(zRecordIdDto), auth: true },
    )
    .patch(
      '/update',
      ...
      { body: dto.SupplierUpdateDto, response: createSuccessResponseSchema(zRecordIdDto), auth: true },
    )
    .delete(
      '/remove',
