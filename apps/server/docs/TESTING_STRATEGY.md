...
describe('Location Integration', () => {
  ...
  describe('POST /locations', () => {
    ...
    test('should fail with duplicate code', async () => {
      ...
      await expect(
        testCtx.m.location.location.handleCreate(dto, 1)
  ...
  describe('GET /locations/:id', () => {
    ...
    test('should throw on non-existent id', async () => {
      await expect(
        testCtx.m.location.location.handleGetById(999999)
  ...
  describe('DELETE /locations/:id', () => {
    test('should delete location', async () => {
      ...
      await expect(
        testCtx.m.location.location.handleGetById(createdLocationId)
      ).rejects.toThrow('not found')
    })
  })
})
