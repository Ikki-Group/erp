...
interface Data {
  ...
  total: string
  status: { label: string; variant: VariantProps<typeof Badge>['variant'] }
...
const demoData: Array<Data> = [
  {
    ...
    customerAvatar: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=96&h=96&dpr=2&q=80',
    total: '$459.97',
  ...
  },
  {
    ...
    customerAvatar: 'https://images.unsplash.com/photo-1519699047748-de8e457a634e?w=96&h=96&dpr=2&q=80',
    total: '$249.48',
    status: { label: 'Processing', variant: 'info-light' },
    items: [
  ...
  },
  {
    ...
    customerAvatar: 'https://images.unsplash.com/photo-1584308972272-9e4e7685e80f?w=96&h=96&dpr=2&q=80',
    total: '$189.97',
  ...
  },
  {
    ...
    customerAvatar: 'https://images.unsplash.com/photo-1485893086445-ed75865251e0?w=96&h=96&dpr=2&q=80',
    total: '$299.97',
  ...
  },
  {
    ...
    customerAvatar: 'https://images.unsplash.com/photo-1607990281513-2c110a25bd8c?w=96&h=96&dpr=2&q=80',
    total: '$179.97',
    status: { label: 'Pending', variant: 'warning-light' },
    items: [
  ...
  },
  {
    ...
    customerAvatar: 'https://images.unsplash.com/photo-1527980965255-d3b416303d12?w=96&h=96&dpr=2&q=80',
    total: '$329.95',
    status: { label: 'Shipped', variant: 'primary-light' },
    items: [
  ...
  },
  {
    ...
    customerAvatar: 'https://images.unsplash.com/photo-1620075225255-8c2051b6c015?w=96&h=96&dpr=2&q=80',
    total: '$89.97',
    status: { label: 'Delivered', variant: 'success-light' },
    items: [
  ...
  },
  {
    ...
    customerAvatar: 'https://images.unsplash.com/photo-1485206412256-701ccc5b93ca?w=96&h=96&dpr=2&q=80',
    total: '$199.98',
    status: { label: 'Cancelled', variant: 'destructive-light' },
    items: [
  ...
  },
  {
    ...
    customerAvatar: 'https://images.unsplash.com/photo-1542595913-85d69b0edbaf?w=96&h=96&dpr=2&q=80',
    total: '$149.97',
    status: { label: 'Pending', variant: 'warning-light' },
    items: [
  ...
  },
  {
    ...
    customerAvatar: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=96&h=96&dpr=2&q=80',
    total: '$279.96',
    status: { label: 'Shipped', variant: 'primary-outline' },
    items: [
  ...
  return (
    <div className="bg-background p-4">
      <DataGrid
        ...
        tableLayout={{ cellBorder: true, rowBorder: true, headerBackground: true, headerBorder: true }}
      >
...
export function PDataGrid9() {
    ...
    () => [
      {
        ...
        cell: ({ row }) => {
          return row.getCanExpand() ? (
            ...
            >
              {row.getIsExpanded() ? <SquareMinusIcon className="size-3.5" /> : <SquarePlusIcon className="size-3.5" />}
            </Button>
          ) : null
        },
        size: 25,
        enableResizing: false,
        meta: { expandedContent: (row) => <OrderItemsSubTable items={row.items} /> },
      },
      {
  ...
  const table = useReactTable({
    ...
    state: { pagination, sorting, expanded: expandedRows, columnOrder },
  ...
  return (
    <DataGrid
      ...
      tableLayout={{ columnsPinnable: true, columnsMovable: true, columnsVisibility: true }}
    >
      <div className="w-full space-y-2.5">
        <DataGridContainer>
          <ScrollArea>
