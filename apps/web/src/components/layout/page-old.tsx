...
function PageTitleContainer({ className, ref, ...props }: PageTitleContainerProps) {
  return <div ref={ref} className={cn("flex flex-col gap-1 min-w-0", className)} {...props} />;
}
...
function PageTitle({ className, size = "md", truncate = false, ref, ...props }: PageTitleProps) {
  return (
    <h1
      ref={ref}
      className={cn(
...
function PageDescription({ className, maxWidth = false, ref, ...props }: PageDescriptionProps) {
  return (
    <p
      ref={ref}
      className={cn(
...
function PageActions({ className, mobileAlign = "right", ref, ...props }: PageActionsProps) {
  return (
    <div
      ref={ref}
      className={cn(
...
function PageBreadcrumb({ className, ref, ...props }: PageBreadcrumbProps) {
  return (
    <div ref={ref} className={cn("flex items-center gap-2 text-sm mb-2", className)} {...props} />
  );
}
...
function PageHeaderContent({ className, ref, ...props }: PageHeaderContentProps) {
  return (
    <div
      ref={ref}
      className={cn(
