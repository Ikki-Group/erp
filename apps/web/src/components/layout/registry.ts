...
export const layoutRegistry: ComponentRegistry = {
	...
	components: [
		...
		},
		{
			...
			file: './form-layout',
			description:
				'Layout system for data entry. Optimized with CVA-driven FormGrid and sticky action bars.',
			usage:
		...
		},
		{
			...
			file: './form-dialog',
			description:
				'Standard layout for simple form dialogs. Provides consistent header/body/footer structure.',
			usage:
		...
		},
		{
			...
			file: './breadcrumbs',
			description:
				'Auto-generated navigation trail with refined typography and smooth transitions.',
			usage:
				'Integrated into AppLayout header. Automatically resolves menu titles and hierarchy from app-menu config.',
