...
export const providersRegistry: ComponentRegistry = {
	...
	title: 'Providers',
	description:
		'Global application context providers for theming, feature flags, and cross-cutting concerns.',
	readonly: false,
	components: [
		{
			...
			file: './theme',
			description:
				'Theme toggle button (light/dark/system) and listener that syncs theme changes to meta tags.',
			usage:
