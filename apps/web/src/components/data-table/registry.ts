...
export const dataTableRegistry: ComponentRegistry = {
  ...
  components: [
    ...
    },
    {
      name: 'useDataTable',
      file: './use-data-table',
      description: 'Hook that creates a configured TanStack Table instance from columns, data, and pagination state.',
      usage: 'Call in feature components: `const table = useDataTable({ columns, data, pageCount, rowCount, ds })`.',
    ...
    },
    {
      ...
      description: 'Pagination controls with page size selector, page navigation, and record count display.',
    ...
    },
    {
      ...
      usage: 'Use for complex filtering scenarios. For standard table filtering, prefer DataGridFilter from reui.',
