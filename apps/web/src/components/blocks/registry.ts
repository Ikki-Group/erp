...
export const blocksRegistry: ComponentRegistry = {
  ...
  components: [
    ...
    },
    {
      ...
      usage: 'Use for compact status indicators in tables or lists where a full badge is too heavy.',
    ...
    },
    {
      ...
      usage: 'Use for detail pages when you need a more semantic HTML structure. Prefer DataList for simpler cases.',
    ...
    },
    {
      ...
      usage: 'Use in dashboard pages for KPI display: `<CardStat label="Revenue" value="Rp 1.2M" trend="+12%" />`.',
