...
export const TransferItemDto = z.object({ materialId: zId, qty: zNum.positive('Quantity must be positive') })
...
export const UsageItemDto = z.object({ materialId: zId, qty: zNum.positive('Quantity must be positive') })
