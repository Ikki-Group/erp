						...
						<div className="flex items-start gap-4 max-w-sm">
							...
							<div className="grid gap-1.5 leading-none">
								...
								<p className="text-sm text-muted-foreground">
									Aktifkan jika produk memiliki pilihan ukuran atau jenis yang berbeda (misal:
									Large, Hot).
								</p>
							</div>
						</div>
					...
					{(field) => (
						<div className="flex items-start gap-4 max-w-sm">
							...
							<div className="grid gap-1.5 leading-none">
								...
								<p className="text-sm text-muted-foreground">
									Aktifkan jika harga produk dibedakan berdasarkan platform / tipe pesanan (misal:
									Dine In vs GrabFood).
								</p>
							</div>
						</div>
