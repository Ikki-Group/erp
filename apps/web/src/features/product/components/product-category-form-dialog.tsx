...
export const ProductCategoryFormDialog =
  createCallable<ProductCategoryFormDialogProps>(props => {
    const { call, id } = props
    ...
    const create = useMutation({
      mutationFn: productCategoryApi.create.mutationFn,
    })
    const update = useMutation({
      mutationFn: productCategoryApi.update.mutationFn,
    })
    ...
    const form = useAppForm({
      ...
      onSubmit: async ({ value }) => {
        ...
        await toast
          .promise(
            promise,
            toastLabelMessage(isCreate ? 'create' : 'update', 'kategori produk')
          )
          .unwrap()
