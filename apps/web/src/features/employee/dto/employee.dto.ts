...
import { zId, zMetadataDto, zPaginationDto, zQuerySearch, zRecordIdDto, zStr, zStrNullable } from '@/lib/zod'
...
export const EmployeeFilterDto = z.object({ ...zPaginationDto.shape, q: zQuerySearch })
