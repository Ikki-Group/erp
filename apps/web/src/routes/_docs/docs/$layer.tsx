    ...
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="space-y-2 mb-8 pb-6 border-b">
        ...
        <p className="text-sm text-muted-foreground">
          <span className="font-medium text-foreground">{registry.components.length}</span> registered components
        </p>
      </div>
  ...
  return (
    <div className="rounded-xl border bg-card overflow-hidden">
      ...
      <div className="px-5 py-4 space-y-4">
        ...
        {/* Import Path */}
        <div>
          <h4 className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1.5">Import</h4>
          <div className="flex items-center gap-2">
        ...
        {/* Exports */}
        <div>
          <h4 className="text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1.5">Exports</h4>
          <div className="flex flex-wrap gap-1.5">
            {entry.exports.map((exp) => (
              <code key={exp} className="bg-primary/10 text-primary text-xs px-2 py-0.5 rounded-md font-mono">
                {exp}
              </code>
            ))}
          </div>
