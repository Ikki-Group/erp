...
import { TrendingUp, TrendingDown, MapPin, ShieldAlert, Users, ArrowUpRight } from "lucide-react";
...
function DashboardPage() {
  ...
  const { data: recentLocations, isLoading: isLoadingLocations } = useRecentLocations();
      ...
      <div className="grid gap-4 grid-cols-1 lg:grid-cols-7">
        <Card className="lg:col-span-4 shadow-sm border-none bg-card/40 backdrop-blur-sm">
          <CardHeader className="p-4 md:p-6 pb-2">
            ...
            <CardDescription>Latest added locations in the system.</CardDescription>
          </CardHeader>
                ...
                <tbody className="divide-y border-t border-border/50">
                  {isLoadingLocations ? (
                    ...
                    recentLocations?.map((location) => (
                      ...
                      >
                        <td className="p-3 md:p-4 align-middle font-medium">{location.name}</td>
