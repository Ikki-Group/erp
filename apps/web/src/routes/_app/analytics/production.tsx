...
export const Route = createFileRoute('/_app/analytics/production')({ component: AnalyticsProductionPage })
...
const rejectConfig = { count: { label: 'Kejadian', color: 'hsl(var(--chart-5))' }, reason: { label: 'Alasan' } }
          ...
          >
            <ChartContainer config={rejectConfig}>
              <BarChart data={rejectReasonData} layout="vertical">
                ...
                <YAxis dataKey="reason" type="category" tickLine={false} tickMargin={10} axisLine={false} width={110} />
