...
function DetailsPage() {
  const accountInfo: Array<DescriptionItem> = [
    { term: 'Full Name', description: 'Isabella Nguyen' },
    {
      term: 'Email Address',
      description: (
    ...
    { term: 'Role', description: <Badge>Administrator</Badge> },
    {
      term: 'Location',
      description: (
  ...
  const orderDetails: Array<DescriptionItem> = [
    { term: 'Order ID', description: <code className="bg-muted px-1.5 py-0.5 rounded text-sm">#ORD-2024-8521</code> },
    {
      term: 'Status',
      description: (
    ...
    { term: 'Total', description: <span className="font-bold text-lg">$250.00</span> },
  ]
      ...
      <Page.Content>
        <Grid>
          ...
          <Card>
            ...
            <CardContent>
              <DescriptionList items={accountInfo} columns={1} className="sm:grid-cols-2 gap-x-12" />
            </CardContent>
          </Card>
              ...
              <DescriptionList
                ...
                items={[
                  ...
                  },
                  {
                    ...
                    description: (
                      <div className="flex items-center gap-2">
                        <code className="bg-muted p-1 rounded text-xs flex-1 truncate">pk_live_51Msz...234</code>
