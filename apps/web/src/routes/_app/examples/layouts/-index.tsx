...
export const Route = createFileRoute('/_app/examples/layouts/')({ component: LayoutsPage })
    ...
    <Page>
      ...
      <Page.Content>
        <Stack gap="xl">
          ...
          {/* Stack Examples */}
          <Section>
            <SectionHeader title="Stack Layout" description="Vertical layout with consistent spacing" />
          ...
          {/* Inline Examples */}
          <Section>
            <SectionHeader title="Inline Layout" description="Horizontal layout with flexible alignment" />
          ...
          {/* Combined Example */}
          <Section>
            <SectionHeader title="Combined Layouts" description="Composing primitives for complex layouts" />
                ...
                <Stack gap="lg">
                  ...
                  <div className="bg-muted/50 p-4 rounded-lg">
                    <p className="text-sm text-muted-foreground">
                      This example combines Grid, Stack, and Inline primitives to create a dashboard layout without any
                      custom className at the screen level.
                    </p>
                  </div>
                </Stack>
              </CardContent>
