                ...
                <CardContent>
                  <div className="grid grid-cols-3 gap-4 text-center">
                    <div className="bg-muted/50 rounded-lg p-4">
                      ...
                      <div className="text-muted-foreground mt-1 text-xs font-bold uppercase">Uptime</div>
                    </div>
                    <div className="bg-muted/50 rounded-lg p-4">
                      <div className="text-primary text-2xl font-bold">24ms</div>
                      <div className="text-muted-foreground mt-1 text-xs font-bold uppercase">Latency</div>
                    </div>
                    <div className="bg-muted/50 rounded-lg p-4">
                      <div className="text-primary text-2xl font-bold">1.2GB</div>
                      <div className="text-muted-foreground mt-1 text-xs font-bold uppercase">Bandwidth</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
