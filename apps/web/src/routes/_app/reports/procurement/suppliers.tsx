...
export default function ProcurementSuppliersReportRoute() {
	...
	return (
		<Page size="xl">
			<Page.BlockHeader title="Supplier Performance" description="Evaluasi kinerja supplier berdasarkan PO." />
