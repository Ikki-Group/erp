...
export const Route = createFileRoute('/_app/reports/insights/inventory-turnover')({
...
function RouteComponent() {
	...
	const avgTurnover =
		chartData.length > 0 ? chartData.reduce((s, d) => s + d.turnoverRatio, 0) / chartData.length : 0
	const avgDays =
		chartData.length > 0
			? chartData.reduce((s, d) => s + d.daysInInventory, 0) / chartData.length
			: 0
