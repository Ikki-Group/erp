      ...
      <Dialog open={!!completeWoId} onOpenChange={(open) => !open && setCompleteWoId(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Masukkan jumlah aktual (yield) hasil produksi. Pastikan bahan baku telah tercatat dengan benar.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              onClick={() =>
                completeWoId && completeMutation.mutate({ params: { id: completeWoId }, body: { actualQty } })
              }
