...
const mockAccounts = [
  { id: 1, code: '1-1001', name: 'Kas Kecil (Petty Cash)', type: 'ASSET', isGroup: false, balance: 2500000 },
  { id: 2, code: '1-1002', name: 'Bank BCA', type: 'ASSET', isGroup: false, balance: 125000000 },
  { id: 3, code: '1-2001', name: 'Piutang Usaha', type: 'ASSET', isGroup: false, balance: 14500000 },
  { id: 4, code: '2-1001', name: 'Hutang Dagang', type: 'LIABILITY', isGroup: false, balance: 28000000 },
  { id: 5, code: '3-1001', name: 'Modal Disetor', type: 'EQUITY', isGroup: false, balance: 500000000 },
  { id: 6, code: '4-1001', name: 'Pendapatan Penjualan', type: 'REVENUE', isGroup: false, balance: 85000000 },
  { id: 7, code: '5-1001', name: 'Biaya Bahan Baku', type: 'EXPENSE', isGroup: false, balance: 35000000 },
]
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <Card>
            <Card.Header className="flex flex-row items-center justify-between pb-2">
              <Card.Title className="text-sm font-medium text-muted-foreground">Total Kas & Bank</Card.Title>
              <WalletIcon className="h-4 w-4 text-emerald-500" />
            </Card.Header>
            <Card.Content>
              <div className="text-2xl font-bold font-mono tracking-tight text-emerald-600">Rp 127.500.000</div>
          ...
          <Card>
            <Card.Header className="flex flex-row items-center justify-between pb-2">
              <Card.Title className="text-sm font-medium text-muted-foreground">Piutang Berjalan</Card.Title>
          ...
          <Card>
            <Card.Header className="flex flex-row items-center justify-between pb-2">
              <Card.Title className="text-sm font-medium text-muted-foreground">Liabilitas (Hutang)</Card.Title>
              <BuildingIcon className="h-4 w-4 text-rose-500" />
            </Card.Header>
            <Card.Content>
              <div className="text-2xl font-bold font-mono tracking-tight text-rose-600">Rp 28.000.000</div>
