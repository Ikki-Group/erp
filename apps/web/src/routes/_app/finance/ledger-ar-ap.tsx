      ...
      <Page.Content className="flex flex-col gap-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            ...
            <Card.Content>
              <div className="text-3xl font-bold font-mono tracking-tight text-emerald-600">Rp 5.000.000</div>
          ...
          <Card>
            ...
            <Card.Content>
              <div className="text-3xl font-bold font-mono tracking-tight text-rose-600">Rp 23.000.000</div>
